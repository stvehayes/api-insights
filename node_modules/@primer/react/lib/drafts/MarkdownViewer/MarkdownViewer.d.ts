...
declare const MarkdownViewer: ({ dangerousRenderedHTML, loading, markdownValue, onChange: externalOnChange, disabled, onLinkClick, openLinksInNewTab, }: MarkdownViewerProps) => React.JSX.Element;
