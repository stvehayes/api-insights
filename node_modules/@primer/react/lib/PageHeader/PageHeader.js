...
const TitleAreaContext = /*#__PURE__*/React__default.default.createContext({
  titleVariant: 'medium',
...
const TitleArea = ({
  ...
  return /*#__PURE__*/React__default.default.createElement(TitleAreaContext.Provider, {
    value: {
...
const LeadingAction = ({
  ...
  const {
    titleAreaHeight
  } = React__default.default.useContext(TitleAreaContext);
  return /*#__PURE__*/React__default.default.createElement(Box, {
    sx: merge__default.default({
      display: 'flex',
